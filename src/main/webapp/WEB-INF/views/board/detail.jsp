...
<div id="wrap" class="form-container" data-bno="${bbb.boardNo}">
    ...
    <div id="content">${bbb.content}, <iframe width="560" height="315" src="https://www.youtube.com/embed/Q3K0TOvTOno?si=xgKBB9Az60dXdlGm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
    <div class="buttons">
